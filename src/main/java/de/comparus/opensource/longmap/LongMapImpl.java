...
public class LongMapImpl<V> implements LongMap<V> {
    ...
    //cache keys and values for better keys() and values() performance
     ...
     *
     * @param key the key
     * @return value corresponding to a key or null
     */
    ...
    //FIXME must return Collection<V> to get better class design and do not use reflection
    public V[] values() {
        if (genericType == null) {
